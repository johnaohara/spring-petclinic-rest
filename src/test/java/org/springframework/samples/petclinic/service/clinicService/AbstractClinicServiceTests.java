 ...
 * configuration using {@link } annotation </p> <p>
...
public abstract class AbstractClinicServiceTests {
    ...
    public void shouldFindOwnersByLastName() {
        ...
        assertThat(owners.size(), equalTo(2));
    ...
    public void shouldFindSingleOwnerWithPet() {
        ...
        assertThat(owner.getPets().size(), equalTo(1));
...
//    }
    ...
    public void shouldFindVets() {
        ...
        assertThat(vet.getSpecialties().get(0).getName(), equalTo("surgery"));
        assertThat(vet.getSpecialties().get(1).getName(), equalTo("dentistry"));
    }
    ...
    public void shouldDeletePet(){
        ...
        try {
            pet = this.clinicService.findPetById(13);
		} catch (Exception e) {
			pet = null;
		}
    ...
    public void shouldFindVisitDyId(){
    	...
    	assertThat(visit.getId(), equalTo(1));
    	assertThat(visit.getPet().getName(), startsWith("Samantha"));
    }
    ...
    public void shouldInsertVisit() {
        ...
        this.clinicService.saveVisit(visit);
        assertThat(visit.getId().longValue(), not(equalTo(0)));

        visits = this.clinicService.findAllVisits();
        assertThat(visits.size(), equalTo(found + 1));
    }
    ...
    public void shouldDeleteVisit(){
    	Visit visit = this.clinicService.findVisitById(4);
        this.clinicService.deleteVisit(visit);
        try {
        	visit = this.clinicService.findVisitById(4);
		} catch (Exception e) {
			visit = null;
		}
    ...
    public void shouldInsertVet() {
        ...
        assertThat(vet.getId().longValue(), not(equalTo(0)));

        vets = this.clinicService.findAllVets();
        assertThat(vets.size(), equalTo(found + 1));
    }
...
//    @Transactional
    ...
    public void shouldDeleteVet(){
    	Vet vet = this.clinicService.findVetById(6);
        this.clinicService.deleteVet(vet);
        try {
        	vet = this.clinicService.findVetById(6);
		} catch (Exception e) {
			vet = null;
		}
    ...
    public void shouldDeleteOwner(){
        ...
        try {
        	owner = this.clinicService.findOwnerById(10);
		} catch (Exception e) {
			owner = null;
		}
    ...
    public void shouldFindAllPetTypes(){
        ...
        PetType petType1 = EntityUtils.getById(petTypes, PetType.class, 1);
        assertThat(petType1.getName(), startsWith("cat"));
        PetType petType3 = EntityUtils.getById(petTypes, PetType.class, 3);
        assertThat(petType3.getName(), startsWith("lizard"));
    }
    ...
    public void shouldInsertPetType() {
        ...
        assertThat(petType.getId().longValue(), not(equalTo(0)));

        petTypes = this.clinicService.findAllPetTypes();
        assertThat(petTypes.size(), equalTo(found + 1));
    }
    ...
    public void shouldDeletePetType(){
    	PetType petType = this.clinicService.findPetTypeById(6);
        this.clinicService.deletePetType(petType);
        try {
        	petType = this.clinicService.findPetTypeById(6);
		} catch (Exception e) {
			petType = null;
		}
    ...
    public void shouldFindSpecialtyById(){
    	...
    	assertThat(specialty.getName(), startsWith("radiology"));
    }
    ...
    public void shouldFindAllSpecialtys(){
        ...
        assertThat(specialty1.getName(), startsWith("radiology"));
        Specialty specialty3 = EntityUtils.getById(specialties, Specialty.class, 3);
        assertThat(specialty3.getName(), startsWith("dentistry"));
    }
    ...
    public void shouldInsertSpecialty() {
        ...
        assertThat(specialty.getId().longValue(), not(equalTo(0)));

        specialties = this.clinicService.findAllSpecialties();
        assertThat(specialties.size(), equalTo(found + 1));
    }
